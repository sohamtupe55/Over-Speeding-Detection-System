...
def detectviolation(event=None):
    speed_limit = entry_1.get()
    print(speed_limit, filename)
    # Initialize the video
    cap = cv2.VideoCapture( filename)
    lane_1_1 = []
    lane_1_2 = []

    mask1 = cv2.imread('m1.jpeg', 1)
                ...
                if cy > 513 and cy < 600:
                    ...
                    if seconds <= 0.2:
                        ...
                        if flag is False:
                            ...
                            #     os.makedirs(path)
                            if int(speed) > int(speed_limit) and w > 70 and h > 100:
                ...
                if cy1 > 513 and cy1 < 600:
                    ...
                    if seconds1 <= 0.2:
                        ...
                        if flag1 is False:
                            ...
                            # if not os.path.exists(path):
                            #     os.makedirs(path)
                            if int(speed1) > int(speed_limit) and cy1 <= 720 and w1 > 70 and h1 > 100:
...
Label(root,text="Traffic Violation System",font="airborne 30 bold").pack(pady=(25,5))
Label(root,text="Please Upload Video file of the Road below",font="airborne 15",pady=10).pack()
button = Button(root, text='UPLOAD VIDEO', command=UploadAction)
button.pack()
label_1 =Label(root,text="Speed Restrictions(kmph):", width=20,font=("bold",10))
label_1.place(x=80,y=170)


entry_1=Entry(root)
entry_1.place(x=260,y=170)

Button(root, text='Detect Violation', command=detectviolation).pack(pady=60)
root.mainloop()
